...
---
## General
This plugin registers custom edge shape renderers. See the following [example code](../../../sigma.js-master/examples/plugin-customEdgeShapes.html) for full usage.
...
To assign a shape renderer to an edge, simply set `edge.type='shape-name'` e.g. `edge.type='dotted'`. The default renderer implemented by sigma.js is named `def` (alias `line`) - see also [generic custom edge renderer example](../../../sigma.js-master/examples/custom-edge-renderer.html).
